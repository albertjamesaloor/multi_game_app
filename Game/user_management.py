...
def update_user_wordler_stats(stats):
    stats["wordler_guessed_words"] += 1
...
def login(win):
    ...
    while not login_successful:
        ...
        understand_surface = font.render("->",  True, white)
        ...
        if is_username:
           win.blit(understand_surface, (input_rect.x - 25, input_rect.y + 13)) 
        else:
            win.blit(understand_surface, (input_rect.x - 25, input_rect.y + 60))
